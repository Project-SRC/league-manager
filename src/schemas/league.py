...
class League(Base, UUIDMixin, TimestampMixin):
    ...
    league_teams: Mapped[list[LeagueTeam]] = relationship("LeagueTeam", back_populates="league")
    league_drivers: Mapped[list[LeagueDriver]] = relationship(
        "LeagueDriver", back_populates="league"
    )
    league_tracks: Mapped[list[LeagueTrack]] = relationship("LeagueTrack", back_populates="league")
...
class Participation(Base, UUIDMixin, TimestampMixin):
    ...
    driver: Mapped[Driver | None] = relationship("Driver", back_populates="participation")
