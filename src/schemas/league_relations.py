...
class LeagueTeam(Base, UUIDMixin, TimestampMixin):
    ...
    league: Mapped[League] = relationship("League", back_populates="league_teams", viewonly=True)
    team: Mapped[Team] = relationship("Team", back_populates="league_teams", viewonly=True)
...
class LeagueDriver(Base, UUIDMixin, TimestampMixin):
    ...
    league: Mapped[League] = relationship("League", back_populates="league_drivers", viewonly=True)
    driver: Mapped[Driver] = relationship("Driver", back_populates="league_drivers", viewonly=True)
...
class LeagueTrack(Base, UUIDMixin, TimestampMixin):
    ...
    league: Mapped[League] = relationship("League", back_populates="league_tracks", viewonly=True)
    track: Mapped[Track] = relationship("Track", back_populates="league_tracks", viewonly=True)
