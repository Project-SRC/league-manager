...
league.include_router(PARTICIPATION, prefix="/v1/race/participation", tags=["Race"])
league.include_router(RACE, prefix="/v1/race", tags=["Race"])
league.include_router(TEAM, prefix="/v1/team", tags=["Team"])
league.include_router(CONTRACT, prefix="/v1/team/contract", tags=["Team"])
league.include_router(TRACK, prefix="/v1/track", tags=["Track"])
league.include_router(USER, prefix="/v1/user", tags=["User"])
league.include_router(DRIVER, prefix="/v1/user/driver", tags=["User"])
league.include_router(MANAGER, prefix="/v1/user/manager", tags=["User"])
league.include_router(STEWARD, prefix="/v1/user/steward", tags=["User"])
